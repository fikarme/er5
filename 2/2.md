...
---
rm -f ./a.out | clang++ -Wall -Werror -Wextra -std=c++98 ASpell.cpp ATarget.cpp Dummy.cpp Fwoosh.cpp Fireball.cpp Polymorph.cpp BrickWall.cpp SpellBook.cpp TargetGenerator.cpp Warlock.cpp main.cpp && ./a.out
